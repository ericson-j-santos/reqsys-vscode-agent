...
python -m reqsys_agent.cli build-index --workspace /caminho/do/projeto
python -m reqsys_agent.cli ask --workspace /caminho/do/projeto --question "Quais workflows existem?"
python -m reqsys_agent.cli semantic-ask --workspace /caminho/do/projeto --question "controle de qualidade de pipelines"
```
...
- `ReqSys Agent: Build Local Context`
- `ReqSys Agent: Ask Local Context`
- `ReqSys Agent: Semantic Ask Local Context`
...
| 0.2 | Indexação local governada + Workspace Reader |
| 0.3 | Busca local simples + busca semântica leve |
